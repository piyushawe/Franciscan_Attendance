...
public class MonthlyLateInCountReport {
  WebDriver dr;
  Utility u= new Utility();
  String r= "MonthlyLateInCountReport";
  ...
  public MonthlyLateInCountReport(WebDriver d)
  {
	  this.dr=d;    
	  PageFactory.initElements(d, this);
  }
  public void openMonthlyLateInCountReport()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Monthly Late In Count Report")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/RptMonthlyLateinCountReport.aspx']")));
  }
