...
public class AttendanceReport {
  ...
  public AttendanceReport(WebDriver d)
  {
	  this.dr=d;    
  ...
  public void openAttendanceReport()
  {
	  ...
	  dr.findElement(By.linkText("Attendance Report")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/RptAttendanceReports.aspx']")));
  }
