...
public class StaffWiseDailyAttendanceReport {
  WebDriver dr;
  Utility u= new Utility();
  String r= "StaffWiseDailyAttendanceReport";
  ...
  public StaffWiseDailyAttendanceReport(WebDriver d)
  {
	  this.dr=d;  
	  PageFactory.initElements(d, this);
  }
  public void openStaffWiseDailyAttendanceReport()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Staff Wise Daily Attendance Report")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/RptStaffWiseDailyAttendanceReport.aspx']")));
  }
