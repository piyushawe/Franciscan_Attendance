...
public class BiometricsAttendanceDetailDepartmentWise {
  WebDriver dr;
  Utility u= new Utility();
  String r= "BiometricsAttendanceDetailDepartmentWise";
  ...
  public BiometricsAttendanceDetailDepartmentWise(WebDriver d)
  {
	  this.dr=d;   
	  PageFactory.initElements(d, this);
  }
  public void openBiometricsAttendanceDetailDepartmentWise()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Biometrics Attendance Detail Department Wise")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/RptBiometricAttendanceDepartmentWise.aspx']")));
  }
