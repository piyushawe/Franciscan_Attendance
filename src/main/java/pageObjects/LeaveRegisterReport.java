...
public class LeaveRegisterReport {
  WebDriver dr;
  Utility u= new Utility();
  String r= "LeaveRegisterReport";
  ...
  public LeaveRegisterReport(WebDriver d)
  {
	  this.dr=d;    
	  PageFactory.initElements(d, this);
  }
  public void openLeaveRegisterReport()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Leave Register Report")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/RptLeaveRegisterReport.aspx']")));
  }
